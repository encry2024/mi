<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/inventory/item*')) }}" href="{{ route('admin.inventory.item.index') }}"><i class="fa fa-archive"></i> {{ __('menus.backend.sidebar.inventory') }}</a>
            </li>
