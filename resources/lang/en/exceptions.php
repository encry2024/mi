    ...
    */
    ...
    'backend' => [
        'inventories' => [
            ...
            'create_error'          => 'There was a problem creating :item. Please try again.',
            'delete_error'          => 'There was a problem deleting :item. Please try again.',
            'delete_first'          => 'Item :item must be deleted first before it can be destroyed permanently.',
            'not_found'             => 'That item does not exist.',
            'restore_error'         => 'There was a problem restoring :item. Please try again.',
            'update_error'          => 'There was a problem updating :item. Please try again.'
        ],
