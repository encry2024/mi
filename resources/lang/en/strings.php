...
return [
    ...
    */
    ...
    'backend' => [
        'items' => [
            'delete_item_confirm'  => 'Are you sure you want to delete :item permanently? Anywhere in the application that references this item\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
